    ...
    <section>
        ...
        <div class="filter">
        	<div class="wrapper">
				...
				<?php echo do_shortcode( '[searchandfilter post_types="projects" taxonomies="locations,bedrooms,1_bedroom,2_bedrooms,3_bedrooms"]' ); ?>
            </div>
        </div>

        <div class="property">
        	<div class="wrapper">
            	<h1><?php printf( __( 'SEARCH RESULTS: %s' ), '<span>' . single_cat_title( '', false ) . '</span>' ); ?></h1>
